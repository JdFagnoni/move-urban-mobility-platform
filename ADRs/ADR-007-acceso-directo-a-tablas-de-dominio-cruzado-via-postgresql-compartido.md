...
Revisado respecto de su versión original: las tablas `vehicles` y `zones` dejaron de ser acceso de dominio cruzado tras su migración al dominio de `transportation-service`; el caso vigente es la lectura de `categories`.
